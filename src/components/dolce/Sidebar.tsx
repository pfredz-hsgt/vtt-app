...
export default function Sidebar() {
    ...
    const menuItems = [
        { name: 'Create Menu', icon: Home, href: '/dolce/create' },
        { name: 'Order', icon: ShoppingCart, href: '/dolce/latest-order' },
        { name: 'Summary', icon: ClipboardList, href: '/dolce/latest-summary' },
        { name: 'Menu History', icon: History, href: '/dolce/history' },
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                    <div style={{
                        ...
                        <span style={{ fontSize: '20px', fontWeight: 'bold' }}>Dolce</span>
                    </div>
